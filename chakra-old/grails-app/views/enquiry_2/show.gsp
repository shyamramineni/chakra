	...
	<body>
		...
		<div id="show-enquiry" class="content scaffold-show" role="main">
			...
			<ol class="property-list enquiry">
				...
				<g:if test="${enquiryInstance?.assigned}">
				<li class="fieldcontain">
					<span id="assigned-label" class="property-label"><g:message code="enquiry.assigned.label" default="Assigned" /></span>
					
						<span class="property-value" aria-labelledby="assigned-label"><g:link controller="user" action="show" id="${enquiryInstance?.assigned?.id}">${enquiryInstance?.assigned?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${enquiryInstance?.enquirySource}">
				<li class="fieldcontain">
					<span id="enquirySource-label" class="property-label"><g:message code="enquiry.enquirySource.label" default="Enquiry Source" /></span>
					
						<span class="property-value" aria-labelledby="enquirySource-label"><g:link controller="enquirySource" action="show" id="${enquiryInstance?.enquirySource?.id}">${enquiryInstance?.enquirySource?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${enquiryInstance?.status}">
				<li class="fieldcontain">
					<span id="status-label" class="property-label"><g:message code="enquiry.status.label" default="Status" /></span>
					
						<span class="property-value" aria-labelledby="status-label"><g:fieldValue bean="${enquiryInstance}" field="status"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${enquiryInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
