...
<html>
	...
	<body><%--
		...
		<div id="create-customer" class="content scaffold-create" role="main">
			<h1><g:message code="Search Customer" args="[entityName]" /></h1>
			...
			<g:form action="searchResults" >
				...
				<fieldset class="buttons">
					<g:submitButton name="search" class="btn-primary" value="${message(code: 'default.button.search.label', default: 'Search')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
