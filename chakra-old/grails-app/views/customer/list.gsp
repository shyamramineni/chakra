...
<body>
	...
	<%--<ul>
		<li><sec:ifAnyGranted
				roles="ROLE_ADMIN,ROLE_SALES,ROLE_PRODMANAGER">
	...
	--%><div id="list-customer" class="content scaffold-list" role="main">
			...
			--%><tbody>
				<g:each in="${customerInstanceList}" status="i"
					...
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						--%>
						<td>
							<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES,ROLE_PRODMANAGER">
		...
		--%>
		<ul>
			<li><sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES,ROLE_PRODMANAGER"><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></sec:ifAnyGranted></li>
		</ul>
