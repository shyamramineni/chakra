	...
	<div id="create-user" class="content scaffold-create" role="main">
		...
		<g:form action="save">
			...
			<fieldset class="buttons">
				<sec:ifAllGranted roles="ROLE_ADMIN"><g:submitButton name="create" class="btn btn-primary"
					value="${message(code: 'default.button.create.label', default: 'Create')}" /></sec:ifAllGranted>
			</fieldset>
		</g:form>
	</div>
</body>
