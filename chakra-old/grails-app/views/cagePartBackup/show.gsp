		...
		<div id="show-cagePart" class="content scaffold-show" role="main">
			...
			<ol class="property-list cagePart">
				...
				<li class="fieldcontain">
					<span id="image-label" class="property-label"><g:message code="cagePart.image.label" default="Image" /></span>
						...
						<span class="property-value" aria-labelledby="image-label"><g:fieldValue bean="${cagePartInstance}" field="image"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${cagePartInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
