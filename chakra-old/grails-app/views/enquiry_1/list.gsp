...
<html>
	...
	<body>
		...
		--%><div id="list-enquiry" class="content scaffold-list" role="main">
			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<g:each in="${enquiryInstanceList}" status="i" var="enquiryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: enquiryInstance, field: "source")}</td>
						...
						<td>
						    ...
						    <sec:ifAllGranted roles="ROLE_ADMIN"><g:link class="editUser" action="editUser" id="${enquiryInstance?.id}">Reassign User</g:link></sec:ifAllGranted>
			...
			<ul>
				<li><sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES"><g:link class="create" action="quotation"><g:message code="default.new.label" args="[entityName]" /></g:link></sec:ifAnyGranted></li>
			</ul>
