		...
		<div id="show-enquiry" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:if test="${enquiryInstance.status != 'QUOTATIONGENERATED'}">
					<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES"><a class="btn btn-primary" href="<g:createLink action="quotation" controller="quotation" params="['enquiry.id': enquiryInstance?.id, 'customer.id': enquiryInstance?.customer?.id]"/>">Create Quotation</a></sec:ifAnyGranted></span>
					</g:if>
