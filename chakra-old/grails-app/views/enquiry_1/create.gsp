		...
		<div id="create-enquiry" class="content scaffold-create" role="main">
			...
			<g:form action="save" >
				...
				<fieldset class="buttons">
					<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES"><g:submitButton name="create" class="btn-primary" value="${message(code: 'default.button.create.label', default: 'Create')}" /></sec:ifAnyGranted>
				</fieldset>
			</g:form>
		</div>
	</body>
