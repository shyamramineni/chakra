...
<html>
	...
	<body>
		...
		<div id="list-wireReceiptReporting" class="content scaffold-list" role="main">
			...
			<ul>
				<li><sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_PRODMANAGER"><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></sec:ifAnyGranted></li>
			</ul>
