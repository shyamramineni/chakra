...
<div class="fieldcontain ${hasErrors(bean: quotationInstance, field: 'createdBy', 'error')} ">
	...
	<g:select id="createdBy" name="createdBy.id" from="${com.chakra.security.User.list()}" optionKey="id" value="${quotationInstance?.createdBy?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: quotationInstance, field: 'lastEditedBy', 'error')} ">
	...
	<g:select id="lastEditedBy" name="lastEditedBy.id" from="${com.chakra.security.User.list()}" optionKey="id" value="${quotationInstance?.lastEditedBy?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
