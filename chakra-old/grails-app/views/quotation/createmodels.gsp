    ...
    <body>
        ...
        <div id="#add-quotationmodel" class="content scaffold-create" role="main">
            ...
            <g:form action="update" >
               ...
               <%--<div class="buttons">
                    <span class="btn-primary"><sec:ifAllGranted roles="ROLE_ADMIN"><g:submitButton class="btn-primary" name="update" class="update" value="${message(code: 'default.button.update.label', default: 'Update')}" /></sec:ifAllGranted></span>
           	  </div>
           --%></g:form>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                          <g:form controller="corder" action="create">
                                             ...
                                             <div class="buttons">
                                                  <span class="button"><sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES"><g:submitButton name="confirmOrder" class="btn btn-primary" value="Confirm Order" /></sec:ifAnyGranted></span>
                                             </div>
                                             </g:if>     
                                          </g:form>
                                      </td>
                         ...
                         <label><b>NEW QUOTATION MODEL:</b></label>             
                           ...
                           <g:form action="addQuotationModel">  
                             ...
                             <g:if test="${(quotationInstance?.status == "NEW") || (quotationInstance?.status =="PENDING")}"> 
	                             <div class="buttons">
	                                  <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES"><g:submitButton class="btn btn-primary" name="addQuotationModel" class="btn btn-primary" value="Add Model" /></sec:ifAnyGranted>
	                             </div>
                             </g:if>
