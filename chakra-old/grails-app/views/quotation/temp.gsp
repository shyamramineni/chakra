...
<html>
    <head>
		...
		<g:set var="entityName" value="${message(code: 'quotation.label', default: 'Quotation Cart')}" />
		<title><g:message code="default.create.label" args="[entityName]" /></title>
		<g:javascript library="jquery" />		
    </head>
    <body>
    	<h2>Quotation Cart</h2>
		<g:form controller="quotation" action="sheetPrices" name="sheetPrices">
		...
		<br>
		<g:form controller="quotation" action="createQuotationCart">
