			...
			<div id="show-customer" class="content scaffold-show" role="main">
				...
				<table border="1" class="table table-bordered">
					<g:each in="${quotationModelInstance}" var="quotationModel">
				    	<tr>
				    		<th>${quotationModel?.cageDesign}:</th>
				    		<td>${quotationModel?.costPerBird}</td>
				    	</tr>
					</g:each>
					<g:if test="${quotationInstance?.isMeshQuotation}">
				    	<tr>
				    		<td colspan="2" align="left">Mesh</td>
				    	</tr>				    	
				    </g:if>
				    ...
				    <g:each in="${quotationModelInstance?.quotationCagePartModel?.quotationCagePartSpecs}" var="cagePartSpec">
						<tr>
							<td colspan="2" align="left">${cagePartSpec?.cagePartSpecification}</td>					    	
						</tr>
					</g:each>
					</g:if>
				</table>				
