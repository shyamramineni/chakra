		...
		<div id="show-userRole" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<sec:ifAllGranted roles="ROLE_ADMIN"><g:link class="edit" action="edit" id="${userRoleInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link></sec:ifAllGranted>
