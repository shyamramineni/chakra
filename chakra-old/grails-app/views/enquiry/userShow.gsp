		...
		<div id="show-enquiry" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SALES"><a class="btn btn-primary" href="<g:createLink action="quotation" controller="quotation" params="['id': enquiryInstance?.id, 'customer': enquiryInstance?.customer?.id]"/>">Create Quotation</a></sec:ifAnyGranted>
