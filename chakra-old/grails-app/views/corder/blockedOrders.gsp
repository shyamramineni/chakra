			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th><g:message code="corder.shippingStatus.label" default="Action" /></th>
				...
				<g:each in="${corderInstanceList}" status="i" var="corderInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_PRODMANAGER"><g:link action="shipOrder" id="${corderInstance.id}">SHIP</g:link>/<g:link action="unBlockStock" id="${corderInstance.id}">UnBlock</g:link></sec:ifAnyGranted></td>
