			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<g:each in="${corderInstanceList}" status="i" var="corderInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><sec:ifAllGranted roles="ROLE_ADMIN"><g:link action="blockStock" id="${corderInstance?.id}"><g:message code="default.button.blockStock.label" default="Block Stock" /></g:link>/<g:link action="partLoad" id="${corderInstance?.id}"><g:message code="default.button.blockStock.label" default="Part Load" /></g:link></sec:ifAllGranted></td>
