...
<html>
	...
	<body><%--
		...
		<div id="list-corder" class="content scaffold-list" role="main">
			<h1><g:message code="default.findCorderByMeshPart.label" args="[entityName]" default="Corders Awaiting MeshPart" /></h1>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th><g:message code="corder.costPerBird.label" default="Cost Per Bird" /></th>												
				...
				<g:each in="${corderInstanceList}" status="i" var="corderInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" controller="customer" id="${corderInstance.customer.id}">${fieldValue(bean: corderInstance, field: "customer")}</g:link></td>
						...
						<td>${fieldValue(bean: corderInstance, field: "paymentStatus")}</td>
