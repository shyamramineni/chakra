	...
	<body>
		...
		<div id="show-cagePartReporting" class="content scaffold-show" role="main">
			...
			<%--<ol class="property-list cagePartReporting">
				...
				<g:if test="${cagePartReportingInstance?.cagePartSpecFormula}">
				<li class="fieldcontain">
					<span id="cagePartSpecFormula-label" class="property-label"><g:message code="cagePartReporting.cagePartSpecFormula.label" default="Cage Part Spec Formula" /></span>
					
						<span class="property-value" aria-labelledby="cagePartSpecFormula-label"><g:link controller="cagePartSpecFormula" action="show" id="${cagePartReportingInstance?.cagePartSpecFormula?.id}">${cagePartReportingInstance?.cagePartSpecFormula?.encodeAsHTML()}</g:link></span>
			...
			<table class="table table-bordered">
				    ...
				    <tr>
				        ...
				        <td>${cagePartReportingInstance.cagePartSpecFormula}</td>
				    </tr>
				    <tr>
