...
<html>
	...
	<body>
		...
		<div id="edit-quotationCagePart" class="content scaffold-edit" role="main">
			...
			<g:form method="post" controller="quotation" ><g:hiddenField name="id" value="${quotationModelInstance?.quotationCageModel?.id}" />
				<g:hiddenField name="version" value="${quotationModelInstance?.quotationCageModel?.version}" />
				...
				<fieldset class="buttons">
					<sec:ifAllGranted roles="ROLE_ADMIN,ROLES_SALES"><g:actionSubmit class="save" action="updateCageModel" value="${message(code: 'default.button.update.label', default: 'Update')}" /></sec:ifAllGranted>
				</fieldset>
			</g:form>
		</div>
	</body>
