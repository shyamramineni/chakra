		...
		<div id="create-stock" class="content scaffold-create" role="main">
			...
			<g:form action="save" >
				...
				<fieldset class="buttons">
					<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_PRODMANAGER"><g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" /></sec:ifAnyGranted>
				</fieldset>
			</g:form>
		</div>
	</body>
