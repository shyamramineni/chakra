	...
	<body>
		...
		<div id="list-sheetSpecification" class="content scaffold-list" role="main">
			...
			<table class="table table-bordered">
				...
				%>
				    <g:if test="${(sheetSpecificationInstance?.crossWireDiameter == sheetSpecificationInstance?.lineWireDiameter1) && (sheetSpecificationInstance?.lineWireDiameter2 > 0)}">
			        ...
			        <g:if test="${sheetSpecificationInstance?.crossWireDiameter == sheetSpecificationInstance?.lineWireDiameter2}">
