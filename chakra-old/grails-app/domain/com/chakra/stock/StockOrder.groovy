...
class StockOrder {
	...
	Corder corder
	Stock stock
	BigDecimal stockForOrder
	Date stockOrderBlockTime
	String comments
	...
	static constraints = {
		...
		//stockOrderBlockTime(min:new Date())
	...
	public String toString() {
		return "StockOrder [corder=" + corder.id + ", stock=" + stock.id+ ", stockForOrder=" + stockForOrder + "]";
	}
