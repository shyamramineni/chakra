...
class StockOrderController {
    ...
    def save() {
		...
		stockOrderInstance.comments = params.comments+" "+"Created By "+springSecurityService.currentUser.toString()+new Date().format("dd/MM/yy-hh:mm")+"<br>"
    ...
    def update() {
		...
		stockOrderInstance.comments = params.comments+" "+"Edited By "+springSecurityService.currentUser.toString()+new Date().format("dd/MM/yy-hh:mm")+"<br>"
