...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#create-cagePartSpecFormula" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="create-cagePartSpecFormula" class="col-12 content scaffold-create" role="main">
                ...
                <g:form resource="${this.cagePartSpecFormula}" controller="${controllerName}" method="POST">
                    <fieldset class="form">
