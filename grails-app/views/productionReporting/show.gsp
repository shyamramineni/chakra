		...
		<div id="show-productionReporting" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="btn btn-primary" action="edit" id="${productionReportingInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					<%--<g:link class="btn btn-primary" action="cancel" id="${productionReportingInstance?.id}"><g:message code="default.button.cancel.label" default="Cancel" /></g:link>
