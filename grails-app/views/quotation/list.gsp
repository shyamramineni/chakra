			...
			<table class="table table-bordered">
				...
				<g:each in="${quotationInstanceList}" status="i" var="quotationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						--%>
						<td><g:link url ="/chakrap/quotation/quotation#/qid/${quotationInstance.id}" id="${quotationInstance.id}" >${fieldValue(bean: quotationInstance, field: "quotationId")}</g:link></td>
						...
						<td><g:link action="cancelQuotation" params="["quotation":quotationInstance.id]">Cancel Quotation</g:link></td>
