...
<div class="fieldcontain ${hasErrors(bean: quotationInstance, field: 'createdBy', 'error')} ">
	...
	<g:select id="createdBy" name="createdBy.id" from="${com.chakra.security.DummyUser.list()}" optionKey="id" required="" value="${quotationInstance?.createdBy?.id}" class="many-to-one"/>
</div>--%>
...
<%--<div class="fieldcontain ${hasErrors(bean: quotationInstance, field: 'lastEditedBy', 'error')} ">
	...
	<g:select id="lastEditedBy" name="lastEditedBy.id" from="${com.chakra.security.DummyUser.list()}" optionKey="id" required="" value="${quotationInstance?.lastEditedBy?.id}" class="many-to-one"/>
</div>
