		...
		<div id="show-quotation" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<%--<g:link class="btn btn-primary" action="edit" id="${quotationInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					<g:link class="btn btn-primary" action="view" params="["quotation":quotationInstance?.id,"quotationModel":quotationModel?.id]" >View</g:link>--%>
					...
					<g:link class="btn btn-primary" action="reValidate" id="${quotationInstance?.id}"><g:message code="default.button.revalidate.label" default="ReValidate" /></g:link>
					</g:if>
				</fieldset>
			</g:form>
		</div>
