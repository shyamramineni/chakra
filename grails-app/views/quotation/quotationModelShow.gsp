		...
		<div id="show-quotation" class="content scaffold-show" role="main">
			...
			<table class="table table-bordered">
			 ...
			 <g:each in="${quotationModelInstance?.quotationChainLinkModel?.quotationChainLinkItems}" var="chainLink">
					...
					<%--<tr>
						<td colspan="9"><g:link class="editChainLink" action="editChainLinkModel" params="["quotation":quotationInstance.id,"quotationModel":quotationModelInstance.id]"><g:message code="quotationModels.cageParts.label" default="Edit ChainLink" /></g:link></td>
					</tr>
			...
			<table class="table table-bordered">
			 ...
			 <g:each in="${quotationModelInstance?.quotationWeldSideModel?.quotationWeldSideItems}" var="weldSide">
					...
					<%--<tr>
						<td colspan="9"><g:link class="editWeldSide" action="editWeldSideModel" params="["quotation":quotationInstance.id,"quotationModel":quotationModelInstance.id]"><g:message code="quotationModels.weldSide.label" default="Edit WeldSideMesh" /></g:link></td>
					</tr>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<%--<g:link class="btn btn-primary" action="quotation" id="${quotationInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					<g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />--%>
					<g:link class="btn btn-primary" action="quotationPdf" id="${quotationInstance?.id}" params="["quotation":quotationInstance.id,"quotationModel":quotationModelInstance.id]"><g:message code="default.button.print.label" default="Print" /></g:link>
				</fieldset>
			</g:form>
		</div>
	</body>
