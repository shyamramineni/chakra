		...
		<div id="show-enquiry" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<a class="btn btn-primary" href="<g:createLink action="quotation" controller="quotation" params="['enquiry': enquiryInstance?.id, 'customer': enquiryInstance?.customer?.id]"/>">Create Quotation</a>
