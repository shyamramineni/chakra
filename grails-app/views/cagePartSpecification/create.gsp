...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#create-cagePartSpecification" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="create-cagePartSpecification" class="col-12 content scaffold-create" role="main">
                ...
                <g:form resource="${this.cagePartSpecification}" controller="${controllerName}" method="POST">
                    <fieldset class="form">
