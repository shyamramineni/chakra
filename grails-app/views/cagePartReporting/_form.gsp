...
<div class="fieldcontain ${hasErrors(bean: cagePartReportingInstance, field: 'cagePart', 'error')} required">
	<label for="cagePart">
		<g:message code="cagePartReporting.cagePart.label" default="Cage Part" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="cagePart" name="cagePart.id" from="${com.chakra.config.CagePart.list()}" optionKey="id" required="" value="${cagePartReportingInstance?.cagePart?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: cagePartReportingInstance, field: 'comments', 'error')} ">
	...
	<g:textField name="comments" value="${cagePartReportingInstance?.comments}"/>
</div>
