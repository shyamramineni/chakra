		...
		<div id="show-customer" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<a class="btn btn-primary" href="<g:createLink action="create" controller="enquiry" params="['customer.id': customerInstance?.id]"/>">Create Enquiry</a>
					<%--
					...
					<g:actionSubmit class="btn btn-primary" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Confirm Delete')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
