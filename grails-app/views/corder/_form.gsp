...
<%--<div class="fieldcontain ${hasErrors(bean: corderInstance, field: 'createdBy', 'error')} ">
	...
	<g:select id="createdBy" name="createdBy.id" from="${com.chakra.security.DummyUser.list()}" optionKey="id" value="${corderInstance?.createdBy?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: corderInstance, field: 'lastEditedBy', 'error')} ">
	...
	<g:select id="lastEditedBy" name="lastEditedBy.id" from="${com.chakra.security.DummyUser.list()}" optionKey="id" value="${corderInstance?.lastEditedBy?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
    ...
    <table>
      <tbody>
            ...
            <tr>
                ...
                <td><g:select id="createdBy" name="createdBy.id" from="${com.chakra.security.DummyUser.list()}" optionKey="id" value="${corderInstance?.createdBy?.id}" class="many-to-one" noSelection="['null': '']"/></td>
            </tr>
      </tbody>
    </table>
</div>
