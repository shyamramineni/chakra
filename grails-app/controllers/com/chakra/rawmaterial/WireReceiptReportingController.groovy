...
class WireReceiptReportingController {
    ...
    def save() {
		...
		wireReceiptReportingInstance.comments = params.comments+" "+"Created By "+"UNKNOWN_USER"+new Date().format("dd/MM/yy-hh:mm")+"<br>"
    ...
    def update() {
		...
		wireReceiptReportingInstance.comments = params.comments+" "+"Edited By "+"UNKNOWN_USER"+new Date().format("dd/MM/yy-hh:mm")+"<br>"
