...
class CustomerController {
	...
	def save() {
		...
		customerInstance.comments = params.comments+"Created By "+"UNKNOWN_USER"+new Date().format("dd/MM/yy-hh:mm")+"<br>"
	...
	def update() {
		...
		customerInstance.comments = customerInstance.comments+" "+"Edited By "+"UNKNOWN_USER"+new Date().format("dd/MM/yy-hh:mm")+"</br>"
	...
	def customerPdf() {
		...
		def customerInstance = Customer.get(params.id)
		def image = new File(servletContext.getRealPath("/images/grails_logo.jpg"))
		//println'image'+image
