...
class Notification {
    ...
    static constraints = {
		...
		createdDate(nullable:true) // timestamp:true is deprecated/removed in some versions, verifying support. Keeping assuming GORM legacy support or update to mapping
